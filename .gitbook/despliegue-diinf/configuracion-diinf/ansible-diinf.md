...
Para el despliegue en el DIINF, **debes utilizar el dominio** de la VM, modificando server\_name con el nombre que corresponda.
...
{% hint style="success" %}
La configuración está completa. Ahora, asegúrate de volver a las [instrucciones](../instrucciones-diinf.md) para revisar cómo ejecutar correctamente el playbook y finalizar el despliegue.
{% endhint %}
